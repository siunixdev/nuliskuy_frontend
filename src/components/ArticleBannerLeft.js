...
const ArticleBannerLeft = ({url, title, subtitle, author, postDate, minRead, backgroundArticleImage, styleFontColor, styleBackgroundColor}) => (
...
export default ArticleBannerLeft;